...
扑一逝長行來看兩種 markdown 个排版程式按怎處理，因為 prettierd proseWrap 無論是 never 抑是 always 攏無理想，目前是設做 preserve，意思等一是無處理即方面个問題，
照原稿原樣保留。但是我毋知 markdownlint-cli2 預設是按怎處理即方面个問題，所又著愛試驗才知影。
