...
I'll compare the two popular Lua linters, Selene and Luacheck, to help you understand their differences and strengths.
...
- **Luacheck** has more mature Neovim integration and is widely used for linting Neovim Lua configs
- **Selene** works well but may need additional configuration for Neovim-specific globals
- Both can be integrated via:
  - `null-ls.nvim` / `none-ls.nvim`
  - `nvim-lint`
  - Native LSP diagnostics
...
- Use **Selene** if you want modern, fast tooling and don't need complex custom rules
- Use **Luacheck** if you need maximum compatibility, mature ecosystem support, or complex inline directives

For Neovim configuration specifically, Luacheck might be slightly better due to its maturity and widespread adoption in the Neovim community, but Selene is perfectly capable and significantly faster.
