...
以上 AI 的處理無效，因為 prettierd 會插手進來，伊那裡沒有設定 line-length，伊就不會管 textwidth option！

我之前裝 community lua pack 就有包括 prettierd 了，伊有某種程度的自動排版，但是沒針對 textwidth 做調整，所以我得看是哪裡還得如何設定。
