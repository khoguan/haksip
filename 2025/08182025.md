...
> 
> * [`'tagfunc'`][tagfunc]
>     - Enables "go to definition" capabilities using [`<C-]>`][tagjump] and
>       other [tag commands][tag-commands].
> * [`'omnifunc'`][omnifunc]
>     - Enables (manual) omni mode completion with `<C-X><C-O>` in Insert mode.
>       For *auto*completion, an [autocompletion
>       plugin](https://github.com/neovim/nvim-lspconfig/wiki/Autocompletion) is
>       required.
