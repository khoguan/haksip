...
2. 證明三角形大角對大邊：用三一律證明。條件：$\angle C > \angle B$，欲證
   $\overline{AB} > \overline{AC}$，則：

   1. AB < AC ? 頭前有證大邊對大角，假使 AB < AC，則 $\angle C < \angle B$，無合。
   2. AB = AC ? 按呢 ABC 是等腰三角形，$\angle C = \angle B$，無合。
   3. 只賰 AB > AC 一種可能性。
